 ...
 * @author Abhishek
 */
public class zen31 extends javax.swing.JFrame {

    /**
     * Creates new form zen31
     */
    public zen31() {
        initComponents();
    }
    ...
    private void initComponents() {
        ...
        jLabel10.setText("Zenfone 3");
        jPanel5.add(jLabel10);
        jLabel10.setBounds(490, 200, 270, 29);

        jLabel4.setIcon(new javax.swing.ImageIcon(getClass().getResource("/Mobile/zen3.jpg"))); // NOI18N
        jPanel5.add(jLabel4);
        ...
        try{
            ...
            new Sign_in().setVisible(true);
                ...
                if(a==JOptionPane.YES_OPTION){
                    ...
                    String query2="insert into products values("+i+",'Zenfone 3',"+quan*15000+",'"+user+"',"+quan+");";
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(zen31.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
