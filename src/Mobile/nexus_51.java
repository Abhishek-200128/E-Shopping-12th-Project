 ...
 * @author Abhishek
 */
public class nexus_51 extends javax.swing.JFrame {

    /**
     * Creates new form nexus_51
     */
    public nexus_51() {
        initComponents();
    }
    ...
    private void initComponents() {
        ...
        jPanel5.add(jPanel6);
        jPanel6.setBounds(0, 0, 1039, 188);

        jLabel10.setFont(new java.awt.Font("Tahoma", 0, 24)); // NOI18N
        jLabel10.setText("Nexus 5");
        jPanel5.add(jLabel10);
        jLabel10.setBounds(490, 200, 270, 29);

        jLabel4.setIcon(new javax.swing.ImageIcon(getClass().getResource("/Mobile/nexus-5.jpg"))); // NOI18N
        jPanel5.add(jLabel4);
        ...
        try{
            ...
            new Sign_in().setVisible(true);
                ...
                if(a==JOptionPane.YES_OPTION){
                    ...
                    String query2="insert into products values("+i+",'Nexus 5',"+quan*11000+",'"+user+"',"+quan+");";
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(nexus_51.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
