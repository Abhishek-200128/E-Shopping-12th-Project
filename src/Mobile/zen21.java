 ...
 * @author Abhishek
 */
public class zen21 extends javax.swing.JFrame {

    /**
     * Creates new form zen21
     */
    public zen21() {
        initComponents();
    }
    ...
    private void initComponents() {
        ...
        jLabel10.setText("Zenfone 2");
        jPanel5.add(jLabel10);
        jLabel10.setBounds(490, 200, 270, 29);

        jLabel4.setIcon(new javax.swing.ImageIcon(getClass().getResource("/Mobile/zen2.jpg"))); // NOI18N
        jPanel5.add(jLabel4);
        ...
        try{
            ...
            new Sign_in().setVisible(true);
                ...
                if(a==JOptionPane.YES_OPTION){
                    ...
                    String query2="insert into products values("+i+",'Zenfone 2',"+quan*22000+",'"+user+"',"+quan+");";
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(zen21.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
