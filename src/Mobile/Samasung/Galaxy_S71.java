 ...
 * @author Abhishek
 */
public class Galaxy_S71 extends javax.swing.JFrame {

    /**
     * Creates new form Galaxy_S71
     */
    public Galaxy_S71() {
        initComponents();
    }
    ...
    private void initComponents() {
        ...
        jLabel10.setText("Samsung Galaxy S7");
        jPanel1.add(jLabel10);
        jLabel10.setBounds(450, 200, 270, 29);

        jLabel4.setIcon(new javax.swing.ImageIcon(getClass().getResource("/Mobile/Samasung/S7.jpg"))); // NOI18N
        jPanel1.add(jLabel4);
        jLabel4.setBounds(230, 280, 140, 260);
        ...
        try{
            ...
            new Sign_in().setVisible(true);
                ...
                if(a==JOptionPane.YES_OPTION){
                    ...
                    String query2="insert into products values("+i+",'Samsung Galaxy S7-64GB',"+quan*31000+",'"+user+"',"+quan+");";
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(Galaxy_S71.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
