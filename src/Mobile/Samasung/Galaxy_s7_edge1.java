 ...
 * @author Abhishek
 */
public class Galaxy_s7_edge1 extends javax.swing.JFrame {

    /**
     * Creates new form Galaxy_s7_edge1
     */
    public Galaxy_s7_edge1() {
        initComponents();
    }
    ...
    private void initComponents() {
        ...
        jLabel10.setText("Samsung Galaxy S7 Edge");
        jPanel1.add(jLabel10);
        jLabel10.setBounds(430, 200, 270, 29);

        jLabel4.setIcon(new javax.swing.ImageIcon(getClass().getResource("/Mobile/Samasung/Samsung_S7_Edge.jpeg"))); // NOI18N
        jPanel1.add(jLabel4);
        ...
        try{
            ...
            new Sign_in().setVisible(true);
                ...
                if(a==JOptionPane.YES_OPTION){
                    ...
                    String query2="insert into products values("+i+",'Samsung Galaxy S7 Edge-32GB',"+quan*40000+",'"+user+"',"+quan+");";
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(Galaxy_s7_edge1.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
