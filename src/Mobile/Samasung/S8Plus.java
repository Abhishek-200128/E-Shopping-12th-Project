 ...
 * @author Abhishek
 */
public class S8Plus extends javax.swing.JFrame {

    /**
     * Creates new form S8Plus
     */
    public S8Plus() {
        initComponents();
    }
    ...
    private void initComponents() {
        ...
        jPanel2Layout.setVerticalGroup(
            ...
            .addGroup(javax.swing.GroupLayout.Alignment.TRAILING, jPanel2Layout.createSequentialGroup()
                ...
                .addGroup(jPanel2Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    .addComponent(jLabelHome)
                    .addComponent(jLabelBack)
                    .addComponent(jLabel22, javax.swing.GroupLayout.PREFERRED_SIZE, 134, Short.MAX_VALUE))
        ...
        jLabel10.setText("Samsung Galaxy S8 Plus");
        ...
        try{
            ...
            new Sign_in().setVisible(true);
                ...
                if(a==JOptionPane.YES_OPTION){
                    ...
                    String query2="insert into products values("+i+",'Samsung Galaxy S8 Plus-32GB',"+quan*67000+",'"+user+"',"+quan+");";
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(S8Plus.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
