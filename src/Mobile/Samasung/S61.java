 ...
 * @author Abhishek
 */
public class S61 extends javax.swing.JFrame {

    /**
     * Creates new form S61
     */
    public S61() {
        initComponents();
    }
    ...
    private void initComponents() {
        ...
        jLabel10.setText("Samsung Galaxy S6");
        jPanel1.add(jLabel10);
        jLabel10.setBounds(430, 200, 270, 29);

        jLabel4.setIcon(new javax.swing.ImageIcon(getClass().getResource("/Mobile/Samasung/S6.jpeg"))); // NOI18N
        jPanel1.add(jLabel4);
        ...
        try{
            ...
            new Sign_in().setVisible(true);
                ...
                if(a==JOptionPane.YES_OPTION){
                    ...
                    String query2="insert into products values("+i+",'Samsung Galaxy S6-32GB',"+quan*22000+",'"+user+"',"+quan+");";
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(S61.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
