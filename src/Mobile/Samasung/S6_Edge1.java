 ...
 * @author Abhishek
 */
public class S6_Edge1 extends javax.swing.JFrame {

    /**
     * Creates new form S6_Edge1
     */
    public S6_Edge1() {
        initComponents();
    }
    ...
    private void initComponents() {
        ...
        jLabel10.setText("Samsung Galaxy S6 Edge");
        jPanel1.add(jLabel10);
        jLabel10.setBounds(430, 200, 270, 29);

        jLabel4.setIcon(new javax.swing.ImageIcon(getClass().getResource("/Mobile/Samasung/samsung-galaxy-s6-edge.jpg"))); // NOI18N
        jPanel1.add(jLabel4);
        ...
        try{
            ...
            new Sign_in().setVisible(true);
                ...
                if(a==JOptionPane.YES_OPTION){
                    ...
                    String query2="insert into products values("+i+",'Samsung Galaxy S6 Edge-32GB',"+quan*33000+",'"+user+"',"+quan+");";
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(S6_Edge1.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
