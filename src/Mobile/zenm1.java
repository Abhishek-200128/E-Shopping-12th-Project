 ...
 * @author Abhishek
 */
public class zenm1 extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jLabel10.setText("Zenfone Max");
        jPanel5.add(jLabel10);
        jLabel10.setBounds(490, 200, 270, 29);

        jLabel4.setIcon(new javax.swing.ImageIcon(getClass().getResource("/Mobile/zenmax.jpeg"))); // NOI18N
        jPanel5.add(jLabel4);
        ...
        try{
            ...
            new Sign_in().setVisible(true);
                ...
                if(a==JOptionPane.YES_OPTION){
                    ...
                    String query2="insert into products values("+i+",'Zenfone Max',"+quan*9000+",'"+user+"',"+quan+");";
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(zenm1.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
