 ...
 * @author Abhishek
 */
public class zens1 extends javax.swing.JFrame {

    /**
     * Creates new form zen2z1
     */
    public zens1() {
        initComponents();
    }
    ...
    private void initComponents() {
        ...
        jPanel5.add(jPanel6);
        jPanel6.setBounds(0, 0, 1039, 185);

        jLabel10.setFont(new java.awt.Font("Tahoma", 0, 24)); // NOI18N
        jLabel10.setText("Zenfone Selfie");
        jPanel5.add(jLabel10);
        jLabel10.setBounds(490, 200, 270, 29);

        jLabel4.setIcon(new javax.swing.ImageIcon(getClass().getResource("/Mobile/zenself.jpg"))); // NOI18N
        jPanel5.add(jLabel4);
        ...
        try{
            ...
            new Sign_in().setVisible(true);
                ...
                if(a==JOptionPane.YES_OPTION){
                    ...
                    String query2="insert into products values("+i+",'Zenfone Selfie',"+quan*11000+",'"+user+"',"+quan+");";
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(zens1.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
