 ...
 * @author Abhishek
 */
public class nexus_5x1 extends javax.swing.JFrame {

    /**
     * Creates new form nexus_5x1
     */
    public nexus_5x1() {
        initComponents();
    }
    ...
    private void initComponents() {
        ...
        jLabel10.setText("Nexus 5X");
        jPanel5.add(jLabel10);
        jLabel10.setBounds(490, 200, 270, 29);

        jLabel4.setIcon(new javax.swing.ImageIcon(getClass().getResource("/Mobile/nexus 5x.jpg"))); // NOI18N
        jPanel5.add(jLabel4);
        ...
        try{
            ...
            new Sign_in().setVisible(true);
                ...
                if(a==JOptionPane.YES_OPTION){
                    ...
                    String query2="insert into products values("+i+",'Nexus 5X',"+quan*15000+",'"+user+"',"+quan+");";
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(nexus_5x1.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
