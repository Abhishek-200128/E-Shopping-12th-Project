 ...
 * @author Abhishek
 */
public class zenz1 extends javax.swing.JFrame {

    /**
     * Creates new form zenz1
     */
    public zenz1() {
        initComponents();
    }
    ...
    private void initComponents() {
        ...
        jLabel10.setText("Zenfone Zoom");
        jPanel5.add(jLabel10);
        jLabel10.setBounds(490, 200, 270, 29);

        jLabel4.setIcon(new javax.swing.ImageIcon(getClass().getResource("/Mobile/zenzoom.jpeg"))); // NOI18N
        jPanel5.add(jLabel4);
        ...
        try{
            ...
            new Sign_in().setVisible(true);
                ...
                if(a==JOptionPane.YES_OPTION){
                    ...
                    String query2="insert into products values("+i+",'Zenfone Zoom',"+quan*24000+",'"+user+"',"+quan+");";
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(zenz1.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
