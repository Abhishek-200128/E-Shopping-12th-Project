 ...
 * @author Abhishek
 */
public class i5s1 extends javax.swing.JFrame {

    /**
     * Creates new form i5s1
     */
    public i5s1() {
        initComponents();
    }
    ...
    private void initComponents() {
        ...
        jLabel10.setText("iPhone 5S");
        jPanel5.add(jLabel10);
        jLabel10.setBounds(490, 200, 270, 29);

        jLabel4.setIcon(new javax.swing.ImageIcon(getClass().getResource("/Mobile/i5sbig.jpg"))); // NOI18N
        jPanel5.add(jLabel4);
        ...
        try{
            ...
            new Sign_in().setVisible(true);
                ...
                if(a==JOptionPane.YES_OPTION){
                    ...
                    String query2="insert into products values("+i+",'iPhone 5S',"+quan*16000+",'"+user+"',"+quan+");";
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(i5s1.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
