 ...
 * @author Abhishek
 */
public class i6plus1 extends javax.swing.JFrame {

    /**
     * Creates new form i6plus1
     */
    public i6plus1() {
        initComponents();
    }
    ...
    private void initComponents() {
        ...
        jLabel10.setText("iPhone 6 Plus");
        jPanel5.add(jLabel10);
        jLabel10.setBounds(490, 200, 270, 29);

        jLabel4.setIcon(new javax.swing.ImageIcon(getClass().getResource("/Mobile/i6plusbig.jpg"))); // NOI18N
        jPanel5.add(jLabel4);
        ...
        try{
            ...
            new Sign_in().setVisible(true);
                ...
                if(a==JOptionPane.YES_OPTION){
                    ...
                    String query2="insert into products values("+i+",'iPhone 6 Plus',"+quan*32000+",'"+user+"',"+quan+");";
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(i6plus1.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
