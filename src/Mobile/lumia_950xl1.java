 ...
 * @author Abhishek
 */
public class lumia_950xl1 extends javax.swing.JFrame {

    /**
     * Creates new form lumia_950xl1
     */
    public lumia_950xl1() {
        initComponents();
    }
    ...
    private void initComponents() {
        ...
        jLabel10.setText("Lumia 950XL");
        jPanel5.add(jLabel10);
        jLabel10.setBounds(490, 200, 270, 29);

        jLabel4.setIcon(new javax.swing.ImageIcon(getClass().getResource("/Mobile/lum950xl.jpeg"))); // NOI18N
        jPanel5.add(jLabel4);
        ...
        try{
            ...
            new Sign_in().setVisible(true);
                ...
                if(a==JOptionPane.YES_OPTION){
                    ...
                    String query2="insert into products values("+i+",'Lumia 950XL',"+quan*30000+",'"+user+"',"+quan+");";
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(lumia_950xl1.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
