 ...
 * @author Abhishek
 */
public class lumia_640xl1 extends javax.swing.JFrame {

    /**
     * Creates new form lumia_640xl1
     */
    public lumia_640xl1() {
        initComponents();
    }
    ...
    private void initComponents() {
        ...
        jLabel10.setText("Lumia 640XL");
        jPanel5.add(jLabel10);
        jLabel10.setBounds(490, 200, 270, 29);

        jLabel4.setIcon(new javax.swing.ImageIcon(getClass().getResource("/Mobile/lum640xl.jpg"))); // NOI18N
        jPanel5.add(jLabel4);
        ...
        jTextArea1.setText("NETWORK\tTechnology\t\nGSM / HSPA\nLAUNCH\tAnnounced\t2015, March\nStatus\tAvailable. Released 2015, April\nBODY\tDimensions\t157.9 x 81.5 x 9 mm (6.22 x 3.21 x 0.35 in)\nWeight\t171 g (6.03 oz)\nSIM\tMicro-SIM\nDISPLAY\tType\tIPS LCD capacitive touchscreen, 16M colors\nSize\t5.7 inches (~69.1% screen-to-body ratio)\nResolution\t720 x 1280 pixels (~259 ppi pixel density)\nMultitouch\tYes\nProtection\tCorning Gorilla Glass 3\n \t- ClearBlack display\nPLATFORM\tOS\tMicrosoft Windows Phone 8.1 with Lumia Denim\nChipset\tQualcomm MSM8226 Snapdragon 400\nCPU\tQuad-core 1.2 GHz Cortex-A7\nGPU\tAdreno 305\nMEMORY\tCard slot\tmicroSD, up to 256 GB (dedicated slot)\nInternal\t8 GB, 1 GB RAM\nCAMERA\tPrimary\t13 MP, f/2.0, 28mm, Carl Zeiss optics, autofocus, LED flash\nFeatures\t1/3\" sensor size\nVideo\t1080p@30fps\nSecondary\t5 MP, 1080p\nSOUND\tAlert types\tVibration; MP3, WAV ringtones\nLoudspeaker\tYes\n3.5mm jack\tYes\nCOMMS\tWLAN\tWi-Fi 802.11 b/g/n, DLNA, hotspot\nBluetooth\tv4.0, A2DP\nGPS\tYes, with A-GPS, GLONASS, BDS\nNFC\tYes\nRadio\tFM radio\nUSB\tmicroUSB v2.0\nFEATURES\tSensors\tAccelerometer, proximity, compass, sensor core\nMessaging\tSMS (threaded view), MMS, Email, Push Email, IM\nBrowser\tHTML5\nJava\tNo\n \t- MP3/WAV/eAAC+/WMA player\n- MP4/H.264/WMV player\n- OneDrive (30 GB cloud storage)\n- Document viewer\n- Photo/video editor\nBATTERY\t \tRemovable Li-Ion 3000 mAh battery\nStand-by\tUp to 936 h (2G) / Up to 936 h (3G)\nTalk time\tUp to 31 h 20 min (2G) / Up to 23 h 40 min (3G)\nMISC\tColors\tMatte cyan, Orange, Black, Matte white, Glossy white\nPrice group\t4/10\nTESTS\tDisplay\tContrast ratio: 1119:1 (nominal), 3.065 (sunlight)\nAudio quality\tNoise -93.0dB / Crosstalk -94.4dB\nBattery life\t\nEndurance rating 74h");
    ...
    private void jLabelBackMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_jLabelBackMouseClicked
        ...
        new Microsoft1().setVisible(true);// TODO add your handling code here:
        ...
        try{
            ...
            new Sign_in().setVisible(true);
                ...
                if(a==JOptionPane.YES_OPTION){
                    ...
                    String query2="insert into products values("+i+",'Lumia 640XL',"+quan*6000+",'"+user+"',"+quan+");";
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(lumia_640xl1.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
