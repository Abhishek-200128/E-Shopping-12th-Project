 ...
 * @author Abhishek
 */
public class lumia_9501 extends javax.swing.JFrame {

    /**
     * Creates new form lumia_9501
     */
    public lumia_9501() {
        initComponents();
    }
    ...
    private void initComponents() {
        ...
        jLabel10.setText("Lumia 950");
        jPanel5.add(jLabel10);
        jLabel10.setBounds(490, 200, 270, 29);

        jLabel4.setIcon(new javax.swing.ImageIcon(getClass().getResource("/Mobile/lum950.jpg"))); // NOI18N
        jPanel5.add(jLabel4);
        ...
        try{
            ...
            new Sign_in().setVisible(true);
                ...
                if(a==JOptionPane.YES_OPTION){
                    ...
                    String query2="insert into products values("+i+",'Lumia 950',"+quan*21000+",'"+user+"',"+quan+");";
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(lumia_9501.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
