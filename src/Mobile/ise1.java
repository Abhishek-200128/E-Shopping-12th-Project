 ...
 * @author Abhishek
 */
public class ise1 extends javax.swing.JFrame {

    /**
     * Creates new form ise1
     */
    public ise1() {
        initComponents();
    }
    ...
    private void initComponents() {
        ...
        jLabel10.setText("iPhone SE");
        jPanel5.add(jLabel10);
        jLabel10.setBounds(490, 200, 270, 29);

        jLabel4.setIcon(new javax.swing.ImageIcon(getClass().getResource("/Mobile/isebig.jpg"))); // NOI18N
        jPanel5.add(jLabel4);
        ...
        try{
            ...
            new Sign_in().setVisible(true);
                ...
                if(a==JOptionPane.YES_OPTION){
                    ...
                    String query2="insert into products values("+i+",'iPhone SE',"+quan*22000+",'"+user+"',"+quan+");";
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(ise1.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
