 ...
 * @author Abhishek
 */
public class ps4pro1 extends javax.swing.JFrame {

    /**
     * Creates new form ps4pro1
     */
    public ps4pro1() {
        initComponents();
    }
    ...
    private void initComponents() {
        ...
        jLabel10.setText("Sony PS 4 Pro");
        jPanel1.add(jLabel10);
        jLabel10.setBounds(460, 210, 170, 29);

        jLabel4.setIcon(new javax.swing.ImageIcon(getClass().getResource("/Gaming/playstation-4-pro.png"))); // NOI18N
        jPanel1.add(jLabel4);
        jLabel4.setBounds(166, 269, 208, 260);
        ...
        try{
            ...
            new Sign_in().setVisible(true);
                ...
                if(a==JOptionPane.YES_OPTION){
                    ...
                    String query2="insert into products values("+i+",'Sony Playststion 4 Pro',"+quan*15000+",'"+user+"',"+quan+");";
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(ps4pro1.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
