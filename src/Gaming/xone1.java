 ...
 * @author Abhishek
 */
public class xone1 extends javax.swing.JFrame {

    /**
     * Creates new form xone1
     */
    public xone1() {
        initComponents();
    }
    ...
    private void initComponents() {
        ...
        jLabel10.setText("Xbox One");
        jPanel1.add(jLabel10);
        jLabel10.setBounds(480, 210, 170, 29);

        jLabel4.setIcon(new javax.swing.ImageIcon(getClass().getResource("/Gaming/xone.png"))); // NOI18N
        jPanel1.add(jLabel4);
        jLabel4.setBounds(144, 269, 230, 260);
        ...
        try{
            ...
            new Sign_in().setVisible(true);
                ...
                if(a==JOptionPane.YES_OPTION){
                    ...
                    String query2="insert into products values("+i+",'XBOX One',"+quan*12000+",'"+user+"',"+quan+");";
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(xone1.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
