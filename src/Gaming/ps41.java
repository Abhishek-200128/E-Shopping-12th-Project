 ...
 * @author Abhishek
 */
public class ps41 extends javax.swing.JFrame {

    /**
     * Creates new form ps41
     */
    public ps41() {
        initComponents();
    }
        ...
        try{
            ...
            new Sign_in().setVisible(true);
                ...
                if(a==JOptionPane.YES_OPTION){
                    ...
                    String query2="insert into products values("+i+",'Sony Playststion 4',"+quan*10000+",'"+user+"',"+quan+");";
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(ps41.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
