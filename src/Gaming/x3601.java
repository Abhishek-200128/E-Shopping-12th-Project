 ...
 * @author Abhishek
 */
public class x3601 extends javax.swing.JFrame {

    /** Creates new form x3601 */
    public x3601() {
        initComponents();
    }
    ...
    private void initComponents() {
        ...
        jLabel10.setText("XBOX 360");
        jPanel1.add(jLabel10);
        jLabel10.setBounds(470, 210, 140, 29);

        jLabel4.setIcon(new javax.swing.ImageIcon(getClass().getResource("/Gaming/xbox360.PNG"))); // NOI18N
        jPanel1.add(jLabel4);
        jLabel4.setBounds(180, 269, 194, 260);
        ...
        try{
            ...
            new Sign_in().setVisible(true);
                ...
                if(a==JOptionPane.YES_OPTION){
                    ...
                    String query2="insert into products values("+i+",'XBOX 360',"+quan*8000+",'"+user+"',"+quan+");";
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(x3601.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
