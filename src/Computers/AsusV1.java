 ...
 * @author Abhishek
 */
public class AsusV1 extends javax.swing.JFrame {

    /**
     * Creates new form AsusV1
     */
    public AsusV1() {
        initComponents();
    }
    ...
    private void initComponents() {
        ...
        jLabel10.setText("Asus Vivobook Max");
        jPanel1.add(jLabel10);
        jLabel10.setBounds(460, 210, 210, 29);

        jLabel4.setIcon(new javax.swing.ImageIcon(getClass().getResource("/Computers/asus vivo.jpg"))); // NOI18N
        jPanel1.add(jLabel4);
        ...
        try{
            ...
            new Sign_in().setVisible(true);
                ...
                if(a==JOptionPane.YES_OPTION){
                    ...
                    String query2="insert into products values("+i+",'Asus Vivobook Max',"+quan*20000+",'"+user+"',"+quan+");";
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(AsusV1.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
