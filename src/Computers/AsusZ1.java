 ...
 * @author Abhishek
 */
public class AsusZ1 extends javax.swing.JFrame {

    /**
     * Creates new form AsusZ1
     */
    public AsusZ1() {
        initComponents();
    }
    ...
    private void initComponents() {
        ...
        jLabel10.setText("Asus Zenbook 3");
        jPanel1.add(jLabel10);
        jLabel10.setBounds(470, 210, 200, 29);

        jLabel4.setIcon(new javax.swing.ImageIcon(getClass().getResource("/Computers/AsusZenbook3-UX390UA.JPG"))); // NOI18N
        jPanel1.add(jLabel4);
        ...
        try{
            ...
            new Sign_in().setVisible(true);
                ...
                if(a==JOptionPane.YES_OPTION){
                    ...
                    String query2="insert into products values("+i+",'Asus Zenbook 3',"+quan*27000+",'"+user+"',"+quan+");";
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(AsusZ1.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
