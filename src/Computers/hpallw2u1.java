 ...
 * @author Abhishek
 */
public class hpallw2u1 extends javax.swing.JFrame {

    /**
     * Creates new form hpallw2u1
     */
    public hpallw2u1() {
        initComponents();
    }
    ...
    private void initComponents() {
        ...
        jLabel10.setText("HP All in One W2U00AA");
        jPanel1.add(jLabel10);
        jLabel10.setBounds(420, 200, 270, 29);

        jLabel4.setIcon(new javax.swing.ImageIcon(getClass().getResource("/Computers/hp w2u00aa_1.PNG"))); // NOI18N
        jPanel1.add(jLabel4);
        ...
        jTextArea1.setText("Processor:\tAMD E-Series\nProcessor Speed:\t1.8 GHz\nCache:\t2 MB\nRAM:\t4 GB\nRAM Type:\tDDR3\nRAM Speed:\t1600 MHZ\nStorage Type:\tHDD\nOperating System:\tFree DOS\nPeriperhals:\tKeyboard, Mouse\nConnectivity:\tUSB\nDisplay Type:\tHD Plus\nResolution:\t1600x900\nHDD Reading Speed:\t7200 RPM\nDimension(WxDxH)mm :\t495x184x370\nWeight:\t4.4\nWarranty:\t1\nScreen Sizes(Inches):\t19.5\nHDD Capacity:\t1 TB\nGraphics Solution:\tAMD\nModel Type:\tAll-in-one\nTouchscreen:\tNo\nUsage:\tHome\nScreen Type:\tLED\nColor:\tBlack\nFeatures:\tHD Plus Desktops\nOther Features:\tHP Webcam with dual array digital microphone, Ultra Slim-tray SuperMulti DVD burner");
        ...
        try{
            ...
            new Sign_in().setVisible(true);
                ...
                if(a==JOptionPane.YES_OPTION){
                    ...
                    String query2="insert into products values("+i+",'HP All in One W2U00AA',"+quan*28000+",'"+user+"',"+quan+");";
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(hpallw2u1.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
