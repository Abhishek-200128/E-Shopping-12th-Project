 ...
 * @author Abhishek
 */
public class AsusC1 extends javax.swing.JFrame {

    /**
     * Creates new form AsusC1
     */
    public AsusC1() {
        initComponents();
    }
    ...
    private void initComponents() {
        ...
        jLabel10.setText("Asus Chromebook");
        jPanel1.add(jLabel10);
        jLabel10.setBounds(450, 210, 200, 29);

        jLabel4.setIcon(new javax.swing.ImageIcon(getClass().getResource("/Computers/asus chromebook.jpg"))); // NOI18N
        jPanel1.add(jLabel4);
        ...
        try{
            ...
            new Sign_in().setVisible(true);
                ...
                if(a==JOptionPane.YES_OPTION){
                    ...
                    String query2="insert into products values("+i+",'Asus Chromebook',"+quan*15000+",'"+user+"',"+quan+");";
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(AsusC1.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
