 ...
 * @author Abhishek
 */
public class Hpallw21 extends javax.swing.JFrame {

    /**
     * Creates new form Hpallw21
     */
    public Hpallw21() {
        initComponents();
    }
    ...
    private void initComponents() {
        ...
        jLabel10.setText("HP All in One W2U07AA");
        jPanel1.add(jLabel10);
        jLabel10.setBounds(420, 200, 270, 29);

        jLabel4.setIcon(new javax.swing.ImageIcon(getClass().getResource("/Computers/hp W2u07aa.PNG"))); // NOI18N
        jPanel1.add(jLabel4);
        ...
        jTextArea1.setText("OS\nOperating system\tWindows 10 Home 64\nPROCESSOR\nProcessor\tIntel® Pentium® J3710 (1.6 GHz, up to 2.64 GHz, 2 MB cache, 4 cores)\nMEMORY\nMemory, standard\t4 GB DDR3L-1600 SDRAM (1 x 4 GB)\nSTORAGE\nHard drive description\t1 TB 7200 rpm SATA\nGRAPHICS\nGraphics\tIntegrated\nGraphics\tIntel® HD Graphics 405\nOPTICAL DISK DRIVE\nOptical drive\tUltra Slim-tray SuperMulti DVD burner\nDISPLAY\nDisplay\t19.5\" FHD display\nDisplay\t19.5\" diagonal FHD VA WLED-backlit (1920 x 1080)\nCONNECTIVITY\nNetwork interface\tIntegrated 10/100/1000 Gigabit Ethernet LAN\nWireless\t802.11b/g/n (1x1) and Bluetooth® 4.0 combo\nPORTS/SLOTS\nPorts\t2 USB 2.0; 2 USB 3.0; 1 headphone/microphone combo\nINPUT\nWebcam\tHP Webcam with dual array digital microphone\nPointing device\tHP USB Wired Optical Mouse\nKeyboard\tHP USB Wired Keyboard with volume control\nAUDIO\nAudio features\tDTS Sound+ Audio with dual 2 W speakers\nPOWER\nPower supply type\t65 W AC power adapter\nMACHINE DIMENSIONS & WEIGHT\nWeight\t4.4 kg\nMinimum dimensions (W x D x H)\t49.5 x 18.4 x 37 cm\nWARRANTY\nWarranty\t1-year limited parts and labour, toll-free technical phone support for the first 30 days\nSOFTWARE AND APPLICATIONS\nPre-installed software\tCyberLink PowerDirector; CyberLink Power Media Player; Bing; Dropbox; TripAdvisor");
        ...
        try{
            ...
            new Sign_in().setVisible(true);
                ...
                if(a==JOptionPane.YES_OPTION){
                    ...
                    String query2="insert into products values("+i+",'HP All in One W2U07AA',"+quan*35000+",'"+user+"',"+quan+");";
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(Hpallw21.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
