 ...
 * @author Abhishek
 */
public class a151 extends javax.swing.JFrame {

    /**
     * Creates new form a151
     */
    public a151() {
        initComponents();
    }
    ...
    private void initComponents() {
        ...
        jLabel10.setText("Alienware 15");
        jPanel1.add(jLabel10);
        jLabel10.setBounds(480, 210, 170, 29);

        jLabel4.setIcon(new javax.swing.ImageIcon(getClass().getResource("/Computers/alienware15.png"))); // NOI18N
        jPanel1.add(jLabel4);
        ...
        try{
            ...
            new Sign_in().setVisible(true);
                ...
                if(a==JOptionPane.YES_OPTION){
                    ...
                    String query2="insert into products values("+i+",'Alienware 15',"+quan*27000+",'"+user+"',"+quan+");";
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(a151.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
