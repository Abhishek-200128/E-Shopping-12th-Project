 ...
 * @author Abhishek
 */
public class HPP1 extends javax.swing.JFrame {

    /**
     * Creates new form HPP1
     */
    public HPP1() {
        initComponents();
    }
    ...
    private void initComponents() {
        ...
        jLabel10.setText("HP Pavillion");
        jPanel1.add(jLabel10);
        jLabel10.setBounds(490, 200, 200, 29);

        jLabel4.setIcon(new javax.swing.ImageIcon(getClass().getResource("/Computers/hp pavillionp4m05aa.PNG"))); // NOI18N
        jPanel1.add(jLabel4);
        ...
        try{
            ...
            new Sign_in().setVisible(true);
                ...
                if(a==JOptionPane.YES_OPTION){
                    ...
                    String query2="insert into products values("+i+",'HP Pavillion 4M05AA',"+quan*56000+",'"+user+"',"+quan+");";
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(HPP1.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
