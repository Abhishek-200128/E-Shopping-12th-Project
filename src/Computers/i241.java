 ...
 * @author Abhishek
 */
public class i241 extends javax.swing.JFrame {

    /**
     * Creates new form i241
     */
    public i241() {
        initComponents();
    }
    ...
    private void initComponents() {
        ...
        jLabel10.setText("Inspiron 24");
        jPanel1.add(jLabel10);
        jLabel10.setBounds(490, 200, 270, 29);

        jLabel4.setIcon(new javax.swing.ImageIcon(getClass().getResource("/Computers/inspiron24.jpg"))); // NOI18N
        jPanel1.add(jLabel4);
        ...
        try{
            ...
            new Sign_in().setVisible(true);
                ...
                if(a==JOptionPane.YES_OPTION){
                    ...
                    String query2="insert into products values("+i+",'Inspiron 24',"+quan*40000+",'"+user+"',"+quan+");";
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(i241.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
